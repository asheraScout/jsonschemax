...
class TestBestMatch(TestCase):
    ...
    def test_one_error(self):
        ...
        self.assertEqual(
            exceptions.best_match(validator.iter_errors({})).validator, "minProperties"
        )
...
class TestErrorTree(TestCase):
    def test_it_knows_how_many_total_errors_it_contains(self):
        ...
        errors = [
            exceptions.ValidationError("Something", validator=i) for i in range(8)
        ]
    ...
    def test_regression_multiple_errors_with_instance(self):
        e1, e2 = (
            exceptions.ValidationError(
                "1", validator="foo", path=["bar", "bar2"], instance="i1"
            ),
            exceptions.ValidationError(
                "2", validator="quux", path=["foobar", 2], instance="i2"
            ),
        )
